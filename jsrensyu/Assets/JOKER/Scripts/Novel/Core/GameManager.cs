...
namespace Novel
{
	...
	public class GameManager
	{
        ...
        public DebuggerConsole DC = DebuggerConsole.Instance();
		...
		public void nextOrder(){
            ...
            var aa = DC.Log(currentFile, cmp.line_num, cmp.line);
            if (aa) UnityEngine.Application.LoadLevel("ScenarioDebugger");
